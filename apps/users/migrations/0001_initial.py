    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('youth', 'Youth Innovator'), ('elder', 'Community Elder'), ('partner', 'Partner Organization'), ('staff', 'KCIHH Staff'), ('admin', 'Administrator')], default='youth', max_length=20)),
